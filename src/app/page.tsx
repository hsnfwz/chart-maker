...
function Home() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-3 w-full h-screen p-3">
      ...
      <div className="order-2 lg:order-1 w-full h-[200px] lg:h-full lg:max-w-[200px] overflow-y-scroll flex flex-col gap-3 bg-neutral-100 p-3 rounded-lg text-xs">
        <ChartData />
      </div>

      <div className="order-1 lg:order-2 w-full h-full flex flex-col gap-3 bg-white">
